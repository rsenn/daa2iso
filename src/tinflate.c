...
static void
tinf_build_bits_base(unsigned char* bits, unsigned short* base, int delta, int first) {
  int i, sum;
...
static void
tinf_build_fixed_trees(TINF_TREE* lt, TINF_TREE* dt) {
  int i;
...
static void
tinf_build_tree(TINF_TREE* t, const unsigned char* lengths, unsigned int num) {
...
static unsigned int
tinf_read_bits(TINF_DATA* d, int num, int base) {
  unsigned int val = 0;
...
static int
tinf_decode_symbol(TINF_DATA* d, TINF_TREE* t) {
...
static int
tinf_decode_trees(TINF_DATA* d, TINF_TREE* lt, TINF_TREE* dt) {
  TINF_TREE code_tree;
...
static int
tinf_inflate_block_data(TINF_DATA* d, TINF_TREE* lt, TINF_TREE* dt) {
  while(1) {
...
static int
tinf_inflate_uncompressed_block(TINF_DATA* d) {
...
static int
tinf_inflate_fixed_block(TINF_DATA* d) {
...
static int
tinf_inflate_dynamic_block(TINF_DATA* d) {
